...
export default function(a, b) {
    return viewmill.view({
        ...
        return viewmill.el("<div><h1>Conditions</h1><p><!></p><!><h1>Exprs</h1><!><p><!></p><h1>Lists</h1><!><!><ul><!></ul><h1>Other</h1><!></div>", (container)=>{
            ...
            viewmill.insert(viewmill.cond(()=>(a.getValue()), ()=>(`a = ${a.getValue()}`), ()=>(""), [
                a
            ]), p__1, anchor__1);
            ...
            viewmill.insert(viewmill.expr(()=>(outside(a.getValue())), [
                a
            ]), div__1, anchor__3);
            const p__2 = anchor__3.nextSibling;
            const anchor__4 = p__2.firstChild;
            viewmill.insert(viewmill.expr(()=>(a.getValue() + b.getValue() + c.getValue()), [
                a,
                b,
                c
            ]), p__2, anchor__4);
            ...
            viewmill.insert(viewmill.list(()=>([
                    ...
                    a.getValue()
                        ...
                        viewmill.insert(v, li__1, anchor__8);
                    }))), [
                c,
                b,
                a
